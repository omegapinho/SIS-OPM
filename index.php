...
if (isset($_GET['access_token']))
    { 
         ...
         $profile = '';//urldecode(substr ($data , strpos($data,'profile=')+8));
         $token = $_GET['access_token'];
         $login = array ('access_token'=>$token,'profile'=>$profile);
    }   
...
if (isset($_GET['access_token']))
{
    TSession::setValue('sisopm_sessao', $login);
}    
...
else
{
    ...
    {
        AdiantiCoreApplication::loadPage('LoginForm', '', $login);
    }
}
