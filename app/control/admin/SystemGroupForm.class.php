...
class SystemGroupForm extends TPage
{
    ...
    function __construct()
    {
        ...
        $name->setSize('40%');
        $acess->setSize('40%');
        $system_id->setSize('40%');
        
        //Valores dos campos
        $fer = new TFerramentas();
        $items = $fer->lista_nivel_acesso();
        $acess->addItems($items);
        $acess->setValue(50);
        // validations
        ...
        $this->form->addFields( [new TLabel('Nível de Acesso')], [$acess]);
        $this->form->addFields( [new TLabel('Perfil do Sistema')], [$system_id]);
