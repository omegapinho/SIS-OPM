<?php
/**
 * tipo_incidenteForm Form
 * @author  <your name here>
 */
class tipo_incidenteForm extends TPage
{
    protected $form; // form
 ...
 *------------------------------------------------------------------------------*/
        ...
        // creates the form
        $this->form = new TQuickForm('form_tipo_incidente');
        $this->form->class = 'tform'; // change CSS class
        
        $this->form->style = 'display: table;width:100%'; // change style
        
        // define the form title
        $this->form->setFormTitle('Cadastro dos tipos de incidentes pedagógicos');
        ...
        $this->form->addQuickAction(_t('Back to the listing'),  new TAction(array('tipo_incidenteList', 'onReload')), 'ico_back.png');
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new tipo_incidente;  // create an empty object
