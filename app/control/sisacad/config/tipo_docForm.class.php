 ...
 */
class tipo_docForm extends TPage
{
    protected $form; // form
 ...
 *------------------------------------------------------------------------------*/
        ...
        // creates the form
        $this->form = new TQuickForm('form_tipo_doc');
        $this->form->class = 'tform'; // change CSS class
        
        $this->form->style = 'display: table;width:100%'; // change style
        
        // define the form title
        $this->form->setFormTitle('Tipos de Documentação - Edição');
        ...
        //Valores
        $servico->addItems($fer->lista_tipo_doc());
        $oculto->addItems($fer->lista_sim_nao());

        // add the fields
        $this->form->addQuickField('Id', $id,  100 );
        $this->form->addQuickField('Tipo de Documento', $nome,  400 , new TRequiredValidator);
        $this->form->addQuickField('Sigla referencial', $sigla,  120 , new TRequiredValidator);
        $this->form->addQuickField('Usado para', $servico,  200 , new TRequiredValidator);
        $this->form->addQuickField('Em desuso?', $oculto,  80 );
        ...
        $this->form->addQuickAction(_t('Back to the listing'),  new TAction(array('tipo_docList', 'onReload')), 'ico_back.png');
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new tipo_doc;  // create an empty object
