<?php
/**
 * nivel_pagamentoForm Form
 * @author  <your name here>
 */
class nivel_pagamentoForm extends TPage
{
    protected $form; // form
 ...
 *------------------------------------------------------------------------------*/
        ...
        // creates the form
        $this->form = new TQuickForm('form_nivel_pagamento');
        $this->form->class = 'tform'; // change CSS class
        
        $this->form->style = 'display: table;width:100%'; // change style
        
        // define the form title
        $this->form->setFormTitle('Cadastro dos níveis de pagamento');
        ...
        $this->form->addQuickAction(_t('Back to the listing'),  new TAction(array('nivel_pagamentoList', 'onReload')), 'ico_back.png');
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new nivel_pagamento;  // create an empty object
