<?php
/**
 * titularidadeForm Form
 * @author  <your name here>
 */
class titularidadeForm extends TPage
{
    protected $form; // form
 ...
 *------------------------------------------------------------------------------*/
        ...
        // creates the form
        $this->form = new TQuickForm('form_titularidade');
        $this->form->class = 'tform'; // change CSS class
        
        $this->form->style = 'display: table;width:100%'; // change style
        
        // define the form title
        $this->form->setFormTitle('Cadastro de titularidade');
        ...
        $this->form->addQuickField('Nível', $nivel,  80 , new TRequiredValidator);
        ...
        $this->form->addQuickAction(_t('Back to the listing'),  new TAction(array('titularidadeList', 'onReload')), 'ico_back.png');
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new titularidade;  // create an empty object
