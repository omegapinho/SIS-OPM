<?php
/**
 * turmasmatriculandoForm Form
 * @author  <your name here>
 */
class turmasmatriculandoForm extends TPage
{
    protected $form; // form
 ...
 *------------------------------------------------------------------------------*/
        ...
        // creates the form
        $this->form = new TQuickForm('form_turmasmatriculando');
        $this->form->class = 'tform'; // change CSS class
        
        $this->form->style = 'display: table;width:100%'; // change style
        
        // define the form title
        $this->form->setFormTitle('Cadastro de Turmas para Matrícula');
        ...
        $this->form->addQuickField('Encerrado?', $oculto,  100 );
        $this->form->addQuickField('Data Início', $data_inicio,  120 , new TRequiredValidator);
        ...
        $this->form->addQuickAction(_t('Back to the listing'),  new TAction(array('turmasmatriculandoList', 'onReload')), 'ico_back.png');
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $aberto = turmasmatriculando::where('turma_id','=',$data->turma_id)->
                                          where('oculto','=','S')->load();
            
            
            $object = new turmasmatriculando;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                TTransaction::open('sisacad'); // open a transaction
                $object = new turmasmatriculando($key); // instantiates the Active Record
