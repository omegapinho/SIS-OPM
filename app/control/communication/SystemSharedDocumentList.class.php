...
class SystemSharedDocumentList extends TPage
{
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            $shared_criteria->add(new TFilter('id', 'IN', "(SELECT document_id FROM g_message.system_document_user WHERE system_user_id='$userid')"), TExpression::OR_OPERATOR);
            $shared_criteria->add(new TFilter('id', 'IN', "(SELECT document_id FROM g_message.system_document_group WHERE system_group_id IN ($usergroups))"), TExpression::OR_OPERATOR);
