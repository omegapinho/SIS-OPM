...
{
    const TABLENAME = 'g_system.system_user';
    const PRIMARYKEY= 'id';
   ...
   /**
    ...
    public static function authenticate_web($login, $password)
    {
        $user = self::newFromLogin($login);
        ...
        {
            throw new Exception("Usuário não localizado no sistema.<br>Contate o administrador para criar sua conta.");
        }
    }
}
