...
{
    const TABLENAME = 'g_system.system_group';
    const PRIMARYKEY= 'id';
    ...
    public function __construct($id = NULL)
    {
        ...
        parent::addAttribute('acess');        //Esse item marca quem é adm,gestor, operador etc do sistema
        parent::addAttribute('system_id');    //id do grupo de sistema que o perfil compõe
    }
    ...
    /**
     * Method get_system
     * Sample of usage: $SystemGroup->system->attribute;
    ...
    public function get_system()
    {
        ...
        if (empty($this->system))
            $this->system = new Item($this->system_id);
